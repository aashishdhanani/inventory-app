...
import { getDocs, query, collection, deleteDoc, setDoc, doc, getDoc } from "firebase/firestore";
...
export default function Home() {
  ...
  //async allows the website to not Block while fetching (website freezes if async not there)
  ...
  //calls the code above, nothing depenedecny array so it runs once when page loads
  useEffect(() => {
    updateInventory()
  }, [])
